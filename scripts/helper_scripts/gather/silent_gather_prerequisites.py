...
class SilentGatherPrereqOptions(GatherPrereqOptions):
    ...
    def silent_license_model(self):
        ...
        license_model = gather_var(key="LICENSE", valid_values=valid_values,
        ...
        if license_model is not None:
            ...
            # Use mapped value if old format, otherwise use as-is
            self._license_model = license_mapping.get(license_model, license_model)
